...
class SrsAdapterHttpApiHandler;
...
SRS_DECLARE_PRIVATE: // clang-format on
    ...
    // Stream Caster for MyProto protocol
    ISrsListener *stream_caster_myproto_;
...
SRS_DECLARE_PRIVATE: // clang-format on
    ...
    // Adapter HTTP API handler
    SrsAdapterHttpApiHandler *adapter_api_handler_;
